...
export const Graphics = () => {
  ...
  return (
    <div className="w-full px-4 ">
      ...
      <div className="bg-slate-200 h-64 w-full mb-2 rounded-2xl shadow-md shadow-gray-300">
        <p className="text-center pt-24">Gráfico Grande</p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
        <div className="bg-slate-200 h-56 rounded-2xl shadow-md shadow-gray-300">
